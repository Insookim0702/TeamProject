...
public class registerController extends HttpServlet {
	...
	private void reload(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String todaytotal = gDAO.counting("1");
			String total = gDAO.counting("2");
			String todayvisiter = gDAO.counting("3");
			String usable = gDAO.counting("4");
			...
			request.setAttribute("todaycounting", todaytotal);
			request.setAttribute("total", total);
			request.setAttribute("todayvisiter", todayvisiter);
