    ...
    <div>
      <div>
        ...
        <p>${usable}</p>
			...
			<span><div><table border =1>
			<tr><td colspan ="4" align="center"><h2>학생</h2></td></tr>
			<tr id="time">
			<td width="40%" colspan ="2" id ="output" align="center"></td>
			<td width="40%" height ="60px" colspan ="2" align="center" id = clock>00:00:00</td>
			</tr>
			...
			<tr>
				<td id ="td">
			      ...
			      <c:if test="${it eq 'true'}"><img src = "image/bed1.png" width ="110px"></c:if></td>
			    <td width="200px"></td>
			    <td rowspan="5" width="100px"></td>
			    <td><c:set var ="it" value ="${requestScope.bednum5}"/>
			...
			<tr><td></td>
			    <td width="30px"></td>
			    <td><c:set var ="it" value ="${requestScope.bednum9}"/>
